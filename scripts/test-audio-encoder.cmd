...
rem Ce script compile puis execute les tests natifs du resampler et de l'encodeur Opus.
set "ROOT=%~dp0.."
...
set "TEST=%BUILD%\Release\vassi_audio_encoder_test.exe"
...
"%CMAKE%" --build "%BUILD%" --config Release --target vassi_audio_encoder_test
if errorlevel 1 exit /b 1
